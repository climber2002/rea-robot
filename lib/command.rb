...
# the execute method and robot is the only parameter of this method.
...
module Command
  ...
  # The Place command which places the robot
  class Place
  ...
  # by default it outputs to the console, but you can also supply another output.
  class Report
