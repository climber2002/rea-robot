...
# needs to implement 3 methods in addition to the to_s method:
#
...
# next_move_position: Given a Position(x, y), returns the next position if the robot makes a move
#
# As the Facing classes don't have their own state, for each Facing class we only need one instance,
